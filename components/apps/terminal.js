...
export class Terminal extends Component {
    ...
    return (
      <React.Fragment key={id}>
        <div className="flex w-full h-5">
          <div className="flex">
            <div className=" text-ubt-green">Gurbaj@PC</div>
  ...
  handleCommands = (command, rowId) => {
    const notFoundPostfix =
      "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-gurbaj, trash, settings, sendmsg]";
    ...
    switch (main) {
      ...
      case "pwd":
        ...
        result = str.replace("~", "/home/gurbaj");
        break;
      case "code":
      ...
      case "about-gurbaj":
        if (words[0] === "." || words.length === 0) {
          this.props.openApp("about-gurbaj");
        } else {
          result = "Command '" + main + notFoundPostfix;
        }
        break;
      ...
      case "sudo":
        ...
        result =
          '<iframe src="https://giphy.com/embed/yUscqyw0M6wFxviJLj" width="480" height="480" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/GlobalEsports-noob-noobs-not-allowed-yUscqyw0M6wFxviJLj"></a></p>';
        break;
      default:
        result = "Command '" + main + notFoundPostfix;
    }
